...
-- Add key binding for recent files
...
lvim.builtin.which_key.mappings["u"] = {
  ...
  c = { "<cmd>FloatermNew rails console<CR>", "Rails Console" },
  t = { ":terminal<CR>", "Open  Terminal in Split" },
  s = { "<C-w>x", "Swap Left/Right" },
  d = { "<C-w>r", "Swap Up/Down" },
}
